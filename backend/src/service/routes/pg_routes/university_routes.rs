...
use crate::entities::pg_entities::university::NewUniversity;
...
pub fn create() -> BoxedFilter<(NewUniversity,)> {
...
pub fn update() -> BoxedFilter<(i32, NewUniversity)> {
    let json_body = warp::body::content_length_limit(1024 * 16).and(warp::body::json());
